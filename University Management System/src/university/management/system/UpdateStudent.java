...
public class UpdateStudent extends JFrame implements ActionListener {
                  ...
                  labelx.setText(rs.getString("SSC GPA"));
                   labelxii.setText(rs.getString("HSC GPA"));
                    labelnid.setText(rs.getString("NID"));
                     labelrollno.setText(rs.getString("ROll No"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) 
        {
            ...
            try {
            //Kind of DML command 
            String query = "update student set Address='"+ address +"',Phone='"+phone+"',email='" + email+"',Course='" +course+"',Branch='"+branch+"' where `Roll No`='"+rollno+"'";
            Conn con=new Conn();
